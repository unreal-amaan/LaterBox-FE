...
const cards = [
    ...
    },
    {
        ...
        image: "📌",
        description:
            " Keep your most important categories pinned and in sight.",
    },
    {
...
const Features = () => {
    return (
        <div id="features" className="dark:bg-secondary bg-accent/50 py-20 theme-transition">
            ...
            <p className="text-md sm:text-lg md:text-xl text-center py-6 font-medium font-inter text-primary/80 dark:text-light/70">
                Powerful features designed to make content organization
